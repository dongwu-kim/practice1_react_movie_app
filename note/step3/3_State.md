...
- **3.4 State**
  ...
  - 3.4 State
    ...
    - this. 이게 뭔가요?
      ...
      자, React, JS, TypeScript, 어디서든 사용하고 있는 this. 의 개념에 대해 다뤄봅시다.

      this는 java를 활용하고 계신 분들이라면 쉽게 사용하고, 이해하고 계신 개념일겁니다다. 하지만 처음인 사람에게는 상당히 모호한 "인스턴스"라는 점에서 이 글을 작성하고 있습니다.
