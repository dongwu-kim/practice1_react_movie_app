...
- **3.4 State**
  ...
  - 3.4 State
    ...
    - this. 이게 뭔가요?
      ...
      여기서 `this`는 변수의 늪에서 우릴 꺼내줄 밧줄같은 존재입니다.

      this는 Data를 담고 있는 인스턴스(=클래스 내에 정의된 변수)의 메모리**주소**를 불러오는 하나의 참조변수입니다.
      ...
      **가리킬** 수 있는 상황에서 자주 사용합니다.
      ...
      즉, 말하는 사람과 듣는 사람 양쪽 다 명확하게 어딨는지 알 수 있다는 것이 포인트죠. 우린 이러한 상황을 예시로 들 뿐인데 시야에 없는 전역변수와 외부 변수에 대한 참조변수로는 사용할 수 없다는 것 까지 연결할 수 있습니다. this라는 참조변수는 그러라고 만든 것이니까요 😒😒 너무 단어가 어려운가요?
