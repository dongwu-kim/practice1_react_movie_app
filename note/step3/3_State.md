...
- **3.4 State**
  ...
  - 3.4 State
    ...
    - this. 이게 뭔가요?
      ...
      this는 Data를 담고 있는 인스턴스(=클래스 내에 정의된 변수)의 **주소**를 불러오는 하나의 참조변수입니다.
      ...
      **가리킬** 수 있는 상황에서 자주 사용합니다.
      ...
      즉, 말하는 사람과 듣는 사람 양쪽 다 명확하게 어딨는지 알 수 있다는 것이 포인트죠. 근데 우린 이러한 실상황을 예시로 들 뿐인데 이상하게 시야에 없는 전역변수와 외부 변수에 대한 참조변수로는 사용할 수 없다는 것 까지 연결할 수 있습니다. this라는 참조변수는 그러라고 만든 것이니까요 😒😒 너무 단어가 어려운가요?

      불손하게도 제가 아는 가장 쉬운 개념은 그렇습니다. ㅠㅠ 저도 쉽게 말씀드리고 싶지만, 영어 문법을 기반으로 하는 방법이 가장 쉽겠더라구요.. 이해해주시길 바라고 있습니다. 'this는 우리가 가시적으로 볼 수 있는 class 내 변수에 대한 메모리 주소다!' 라고 말씀드리기에는 가끔 애매한 경우가 잦으니까요!

      그러니 너무 노여워하지 마시고, 이번 chapter에서 사용하는 this는 그러한 용법이라는 것 하나만 이해하고 넘어가주시길 바랍니다. ㅎㅎ.. 나중에 Java class 에 대해서는 더 세세하게 들어갈테니까요.

    > 우리 모두 주소에 대한 이해를 하고 싶다면, Data structure, 자료구조에 대한 공부를 조금이나마 하시면 큰 도움이 되실겁니다. 코더, 프로그래머 모두 해야만 하는 공부가 있다면 자료구조와 알고리즘 정도가 있으니까요! 🤣🤣
